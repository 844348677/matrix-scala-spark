...
/**
  * Created by liuh on 2016/3/28.
  */
object rbdaInScala {
  def main(args: Array[String]) {
    val conf = new SparkConf().setAppName("NewMethod").setMaster("spark://liuh-pc:7077").setJars(List("/home/liuh/workspace/class3/out/artifacts/class3_jar/class3.jar"))
    ...
    val matrix = sc.textFile("hdfs://liuh-pc:9000/input/train01rmstruct.txt").flatMap(_.split("\t")).map(_.toInt)
